        ...
        <table id="user-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.expierd-date')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($user->id); ?>">
                    ...
                    <?php endif; ?>
                    <td><?php echo e(\Carbon\Carbon::parse($user->expires_at)->diffforhumans()); ?></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <a href="<?php echo e(route('organization.payment', [$organization->id , $user->id ] )); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.payment')); ?></a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/albraa/myProjects/bk/adaa-sela/resources/views/organization/user.blade.php ENDPATH**/ ?>