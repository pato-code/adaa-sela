...
Route::get('organization/{organization}/{user}/payment', 'OrganizationController@payments')->name('organization.payment');
Route::get('organization/{organization}/users', 'OrganizationController@users')->name('organization.users');
Route::resource('payment', 'SystemPaymentController');
Route::resource('payments_category', 'PaymentCategoryController');
