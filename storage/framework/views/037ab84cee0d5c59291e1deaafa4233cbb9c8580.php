...
<section>
        ...
        <div class="container-fluid">
            <a href="<?php echo e(route('payments_category.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.add')); ?> <?php echo e(trans('file.payment_category')); ?></a>
        </div>
        ...
        <table id="user-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.fees')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($category->id); ?>">
                    ...
                    <td><?php echo e($category->role->name); ?></td>
                    <td><?php echo e($category->fees); ?></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="<?php echo e(route('payments_category.edit', $category)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                
                                <li class="divider"></li>

                                <?php echo e(Form::open(['route' => ['payments_category.destroy', $category->id], 'method' => 'DELETE'] )); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/albraa/myProjects/bk/adaa-sela/resources/views/payments_category/index.blade.php ENDPATH**/ ?>