...
{{--    @if(in_array("users-add", $all_permission))--}}
        <div class="container-fluid">
            <a href="{{route('payments_category.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.add')}} {{trans('file.payment_category')}}</a>
        </div>
    {{--@endif--}}
...
{{--                                @if(in_array("users-edit", $all_permission))--}}
                                <li>
                                	<a href="{{ route('payments_category.edit', $category) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                {{--@endif--}}
                                <li class="divider"></li>
{{--                                @if(in_array("users-delete", $all_permission))--}}
                                {{ Form::open(['route' => ['payments_category.destroy', $category->id], 'method' => 'DELETE'] ) }}
                                <li>
