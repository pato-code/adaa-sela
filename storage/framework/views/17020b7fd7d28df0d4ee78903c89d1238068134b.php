                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <?php if(auth()->user()->organization_id == null): ?>
                                        <label><strong><?php echo e(trans('file.organization')); ?> *</strong></label>
                                        <select name="organization_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Role...">
                                            <?php $__currentLoopData = $organizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($organization->id); ?>"
                                                    <?php if(session('new_organization') == $organization->id): ?>
                                                        selected
                                                    <?php endif; ?>><?php echo e($organization->name); ?> -- <?php echo e($organization->domain); ?></option>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/albraa/myProjects/bk/adaa-sela/resources/views/user/create.blade.php ENDPATH**/ ?>